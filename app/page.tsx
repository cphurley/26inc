...
export default function Home() {
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* About */}
      <section id="about" className="scroll-mt-14 bg-[linear-gradient(135deg,#0d3557_0%,#114571_40%,#1a5a94_100%)] py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-6">
      ...
      {/* Footer */}
      <footer className="bg-[#0a2d4a] py-6">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 text-[11px] text-white/30">
          <span>&copy; {new Date().getFullYear()} TwentySix Incorporated</span>
          <Image src="/logo.png" alt="TwentySix Inc" width={100} height={17} className="opacity-20" />
        </div>
      </footer>
    </div>
  );
